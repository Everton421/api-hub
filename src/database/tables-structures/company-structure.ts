...
export class CompanyStructure{
  ...
  async createStructure(database_name: string) {
    const database = `\`${database_name}\``;
      ...
      const sqlTables = [
        `CREATE TABLE IF NOT EXISTS ${database}.produtos (
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.servicos (
                    codigo int(11) unsigned NOT NULL AUTO_INCREMENT,
                    id  int(10) unsigned NOT NULL DEFAULT 0,
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.forma_pagamento (
                  codigo int(11) unsigned NOT NULL AUTO_INCREMENT,
                  id int(10) unsigned NOT NULL DEFAULT 0,
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.produtos_pedido (
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.servicos_pedido (
                  pedido bigint(20) unsigned NOT NULL DEFAULT 0,
                  codigo INTEGER NOT NULL,
                  desconto decimal(10,2) DEFAULT 0.00,
                  quantidade decimal(10,2) NOT NULL DEFAULT 0.00,
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.parcelas (
                  pedido bigint(20) unsigned NOT NULL DEFAULT 0,
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.tipos_os (
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.veiculos (
                  codigo  int(11) NOT NULL AUTO_INCREMENT,
                  id int(10) unsigned NOT NULL DEFAULT 0,
        ...
        `CREATE TABLE IF NOT EXISTS ${database}.api_config (
        ...
        ` 
                CREATE TABLE  ${database}.fotos_produtos (
        ...
        ` CREATE TABLE IF NOT EXISTS ${database}.categorias  (
                ...
                `,
        ` CREATE TABLE  IF NOT EXISTS${database}.marcas  (
                  codigo  int(11) NOT NULL AUTO_INCREMENT,
                  id  int(10) unsigned NOT NULL DEFAULT 0,
                  data_cadastro  date NOT NULL DEFAULT '2000-01-01',
                  data_recadastro  datetime NOT NULL DEFAULT '2000-01-01 00:00:00' , 
              ...
              `,
        `
              CREATE TABLE IF NOT EXISTS ${database}.produto_setor  (
              ...
              `,
        `
                CREATE TABLE IF NOT EXISTS ${database}.setores (
                  codigo  int(11) NOT NULL AUTO_INCREMENT,
                  id  varchar(255) NOT NULL DEFAULT '0',
                  descricao  text NOT NULL,
                data_cadastro  date NOT NULL DEFAULT '2000-01-01',
              ...
              `,
        `
              CREATE TABLE IF NOT EXISTS ${database}.movimentos_produtos (
              ...
              `,
        `CREATE TABLE  IF NOT EXISTS ${database}.locais (
                codigo  int(11) NOT NULL AUTO_INCREMENT,
                id  varchar(255) NOT NULL DEFAULT '0',
                descricao  text NOT NULL,
              ...
              `,
        ` CREATE TABLE   IF NOT EXISTS ${database}.distribuicao_locais_setor  (    
            ...
            `,
        `
                CREATE TABLE IF NOT EXISTS ${database}.caracteristicas (
                  codigo  int(11) NOT NULL AUTO_INCREMENT,
                  id  varchar(255) NOT NULL DEFAULT '0',
    ...
    let sql = ` CREATE DATABASE IF NOT EXISTS  ${database}  ;  `;
      ...
      return new Promise(  ( resolve,reject )=>{
       ...
       conn.query(sql, async (err, result) => {
        if (err){ 
           console.log(err);
                console.log(`[X] Ocorreu um erro ao tentar criar o banco de dados ${database_name} :  `, err);
                reject(`[X] Ocorreu um erro ao tentar criar o banco de dados ${database_name} :  ${err}`  );
        }
          ...
          sqlTables.forEach(async (e) => {
            await conn.query(e, async (err, result) => {
              if (err) {
                console.log(`[X] Um ou mais erros ocorreram ao tentar registrar as tabelas da empresa ${database_name} :  `, err);
                reject(`[X] Um ou mais erros ocorreram ao tentar registrar as tabelas da empresa ${database_name}  | ${err}`  );
                
              } else {
                
                console.log(`tabela registrada com sucesso!`);
                resolve (`tabela registrada com sucesso!`);
              }
            });
          });
        }else{
            resolve(`[V] Resultado query criação do banco da empresa ${result}`);
        }
      });
      });
